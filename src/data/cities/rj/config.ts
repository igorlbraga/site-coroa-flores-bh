...
export const config: CityConfig = {
  ...
  name: "Rio de Janeiro",
  nameShort: "RJ",
  capitalCityName: "Rio de Janeiro",
  logoPath: "/logos/rj.webp",
  copy: {
    heroTitle:
    ...
    locationsHeroSubtitle:
      "Entregamos coroas de flores no Rio de Janeiro e em toda a região metropolitana, em até 1 hora.",
    locationsCtaParagraph:
      "Atendemos outras cidades da região metropolitana do Rio de Janeiro e também de todo o Brasil. Consulte a disponibilidade pelo WhatsApp.",
    ...
    locationsMetadataDescription:
      "Entregamos coroas de flores em cemitérios, velórios e crematórios no Rio de Janeiro e região metropolitana. Confira todos os locais de entrega.",
    locationsMetadataOgDescription:
      "Entregamos coroas de flores em cemitérios, velórios e crematórios no Rio de Janeiro e região metropolitana.",
  },
};
